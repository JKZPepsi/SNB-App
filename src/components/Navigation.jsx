...
export function Sidebar({ activeTab, navigateTo, selectedTournamentId, isAdmin }) {
    return (
        <nav className="w-64 bg-[#030303] border-r border-white/10 flex flex-col hidden md:flex shrink-0">
            ...
            {/* 2. WRAP THIS WHOLE DIV IN ISADMIN */}
            {isAdmin && (
...
export function MobileNav({ activeTab, navigateTo, selectedTournamentId , isAdmin}) {
    return (
